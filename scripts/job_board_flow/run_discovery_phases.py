...
Usage:
  python scripts/job_board_flow/run_discovery_phases.py                    # Run all phases
  python scripts/job_board_flow/run_discovery_phases.py --phase 1          # Run only phase 1
  python scripts/job_board_flow/run_discovery_phases.py --target 500        # Stop when 500 sources
  python scripts/job_board_flow/run_discovery_phases.py --dry-run          # Show what would be imported
"""
