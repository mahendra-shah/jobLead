...
Usage:
    python scripts/job_board_flow/monitor_pipeline.py
...
def main():
    ...
    if mongo_ok and pg_ok and gap_ok:
        ...
        if not pg_ok:
            print("   - Check ML processor (run scripts/job_board_flow/run_ml_pipeline.py)")
        ...
        print("\n💡 RECOMMENDATIONS:")
        if not gap_ok:
            print("   - Run ML processor: python scripts/job_board_flow/run_ml_pipeline.py")
