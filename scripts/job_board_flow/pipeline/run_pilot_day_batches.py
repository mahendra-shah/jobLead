...
Each iteration calls scripts/job_board_flow/run_job_ingest_pipeline.py (Mongo sources + checkpoint).

Example (workday, random 3–8 min between batches):
  python3 scripts/job_board_flow/pipeline/run_pilot_day_batches.py --iterations 12 --sleep-min 180 --sleep-max 480
"""
