...
from scripts.job_board_flow.discovery.proxy_pool import get_next_proxy
        ...
        for i, url in enumerate(seeds, 1):
            ...
            for link in links:
                if dry_run:
                    inserted += 1
                    continue
                from scripts.job_board_flow.discovery.base import upsert_discovery_source_into_list
