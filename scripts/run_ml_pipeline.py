...
def main():
    ...
    try:
        ...
        print(f"Job messages found:        {stats['job_messages']}")
        print(f"  ├─ Individual jobs created: {stats['individual_jobs_created']}")
        print(f"  ├─ Companies auto-created:  {stats['companies_created']}")
